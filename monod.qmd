...
species = [1, 2]
measurement_timepoint_ixs = [4, 7, 12, 15, 18]
...
priors = {
    ...
    "prior_a_mu_max": [-1, 0.2],
    "prior_a_ks": [1.3, 0.1],
    "prior_a_gamma": [-0.3, 0.1],
    # parameters that are non-negative:
    "prior_t_mu_max": [-1.4, 0.05],
    "prior_t_ks": [-1.2, 0.05],
    "prior_t_gamma": [-1.2, 0.05],
    "prior_species_zero": [[[-2.1, 0.08], [0.14, 0.015]]] * N_tube,
    "prior_sigma_y": [[-2, 0.15], [-2, 0.15]],
}
```
...
true_param_values = {
    ...
    "t_gamma": 0.14,
    "species_zero": [
        [np.random.normal(0.1, 0.02), np.random.normal(1.2, 0.015)]
        for _ in range(N_tube)
    ],
    "sigma_y": [0.1, 0.1],
    "ln_mu_max_z": np.random.normal(0, 0.05, size=N_strain).tolist(),
    "ln_ks_z": np.random.normal(0, 0.04, size=N_strain).tolist(),
    "ln_gamma_z": np.random.normal(0, 0.03, size=N_strain).tolist(),
}
```
