---
title: "Bayesian statistics and why it is a good fit for biology"
subtitle: "Sytems Biology for Scientific Computing: week one"
format:
  beamer:
    include-in-header:
      text: |
...
1. What are Bayesian statistical inference?
...
::: {.column width="30%"}
![](./img/soup_with_jug.jpg){height=80% fig-align=right}
:::
...
code = "data {} parameters {real theta;} model {theta ~ std_normal();}"
